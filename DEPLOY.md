...
**Order confirmation emails (optional, v2 only):** [deploy-ver.2/order-confirmation-lambda.md](deploy-ver.2/order-confirmation-lambda.md) — SQS + Lambda + SMTP when Stripe marks an order paid.
